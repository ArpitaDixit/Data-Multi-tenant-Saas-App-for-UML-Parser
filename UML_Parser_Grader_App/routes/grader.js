...
var submitGrades1 = function (req, res) {
    ...
    var TenantInsertQuery = "INSERT INTO "+req.body.tenant_table+"( LetterGrade , Grade , CompletionStatus, Comments) VALUES ('" +
        req.body.scale +
        "','" + req.body.grade +
        "','" + req.body.complete +
...
var submitGrades2 = function (req, res) {
    ...
    var TenantInsertQuery = "INSERT INTO "+req.body.tenant_table+"( 4Scale , Points , CompletionStatus, Comments) VALUES ('" +
        req.body.scale +
        "','" + req.body.grade +
        "','" + req.body.complete +
        "','" + req.body.gradecomments +"')";
...
var submitGrades3 = function (req, res) {
    ...
    var TenantInsertQuery = "INSERT INTO "+req.body.tenant_table+"( PercentGrade , Percent , CompletionStatus, Comments) VALUES ('" +
        req.body.scale +
        "','" + req.body.grade +
        "','" + req.body.complete +
        "','" + req.body.gradecomments +"')";
...
var submitGrades4 = function (req, res) {
    ...
    var TenantInsertQuery = "INSERT INTO "+req.body.tenant_table+"( 10Scale , Points , CompletionStatus, Comments) VALUES ('" +
        req.body.scale +
        "','" + req.body.grade +
        "','" + req.body.complete +
        "','" + req.body.gradecomments +"')";
